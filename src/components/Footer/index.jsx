			...
			<div className="flex w-full md:w-5/12">
			  <div className="text-2xl px-4">
				...
				<div className="flex-row my-4">
				  ...
				  >
					<svg
					  className="h-6 transition duration-700 ease-in-out text-gray-700 dark:text-gray-400 hover:text-black dark:hover:text-black"
					  role="img"
					  xmlns="http://www.w3.org/2000/svg"
					  width="24"
					  height="24"
			...
			<div className="flex w-full md:w-5/12 px-4">
			  <div className="text-2xl">
				...
				<p className="mt-2 mb-4 text-gray-600 dark:text-gray-400 text-sm">
				  To get the latest discount from RealEstify.
				</p>
			  ...
			  <div className="flex flex-wrap items-top">
				<div className="w-full  ml-auto">
				  ...
				  <ul className="list-unstyled mt-2 mb-4">
					<li>
					  <a
						className="text-gray-600 dark:text-gray-400 hover:underline py-1 text-sm"
						href="#"
					  >
						Home
					  </a>
